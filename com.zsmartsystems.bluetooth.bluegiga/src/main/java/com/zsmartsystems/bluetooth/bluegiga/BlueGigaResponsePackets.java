...
import com.zsmartsystems.bluetooth.bluegiga.command.connection.BlueGigaChannelMapSetResponse;
...
class BlueGigaResponsePackets {
    ...
    static {
        ...
        packetMap.put(Objects.hash(0x03, 0x05, false), BlueGigaChannelMapSetResponse.class);
