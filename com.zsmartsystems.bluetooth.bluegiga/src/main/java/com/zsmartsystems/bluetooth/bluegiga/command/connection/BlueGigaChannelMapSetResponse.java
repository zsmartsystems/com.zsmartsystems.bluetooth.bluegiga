 ...
 */
public class BlueGigaChannelMapSetResponse extends BlueGigaResponse {
     ...
     */
    public BlueGigaChannelMapSetResponse(int[] inputBuffer) {
    ...
    public String toString() {
        ...
        builder.append("BlueGigaChannelMapSetResponse [connection=");
